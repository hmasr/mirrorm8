...
declare namespace gapi.client {
  ...
  namespace calendar {
    ...
    interface CalendarNotification {
       ...
       * - "sms" - Deprecated. Once this feature is shutdown, the API will no longer return notifications using this method. Any newly added SMS notifications
       * will be ignored. See  Google Calendar SMS notifications to be removed for more information.
       * Notifications are sent via SMS. This value is read-only and is ignored on inserts and updates. SMS notifications are only available for G Suite
       * customers.
    ...
    interface EventReminder {
       ...
       * - "sms" - Deprecated. Once this feature is shutdown, the API will no longer return reminders using this method. Any newly added SMS reminders will be
       * ignored. See  Google Calendar SMS notifications to be removed for more information.
